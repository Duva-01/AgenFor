...
class ForoGeneralScreen extends StatefulWidget {

  ForoGeneralScreen({Key key}) : super(key: key);

  @override
  _ForoGeneralScreenState createState() => _ForoGeneralScreenState();
}

class _ForoGeneralScreenState extends State<ForoGeneralScreen> {
                    ...
                    child: IconButton(
                        ...
                        onPressed: () {
                          if (mensaje.text.isNotEmpty) {
                            almacenarMensaje.collection("Mensajes").doc().set({
...
class MostrarMensajes extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance.collection("Mensajes").orderBy("tiempo").snapshots(),
