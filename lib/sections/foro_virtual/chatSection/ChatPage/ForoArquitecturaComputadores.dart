...
class ForoArquitecturaComputadoresScreen extends StatefulWidget {

  ForoArquitecturaComputadoresScreen({Key key}) : super(key: key);

  @override
  _ForoArquitecturaComputadoresScreenState createState() => _ForoArquitecturaComputadoresScreenState();
}

class _ForoArquitecturaComputadoresScreenState extends State<ForoArquitecturaComputadoresScreen> {
                    ...
                    child: IconButton(
                        ...
                        onPressed: () {
                          if (mensaje.text.isNotEmpty) {
                            almacenarMensaje.collection("ForoArquitecturaComputadores").doc().set({
...
class MostrarMensajes extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance.collection("ForoArquitecturaComputadores").orderBy("tiempo").snapshots(),
