...
class ForoProgramacionScreen extends StatefulWidget {

  ForoProgramacionScreen({Key key}) : super(key: key);

  @override
  _ForoProgramacionScreenState createState() => _ForoProgramacionScreenState();
}

class _ForoProgramacionScreenState extends State<ForoProgramacionScreen> {
                    ...
                    child: IconButton(
                        ...
                        onPressed: () {
                          if (mensaje.text.isNotEmpty) {
                            almacenarMensaje.collection("ForoProgramacion").doc().set({
...
class MostrarMensajes extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance.collection("ForoProgramacion").orderBy("tiempo").snapshots(),
