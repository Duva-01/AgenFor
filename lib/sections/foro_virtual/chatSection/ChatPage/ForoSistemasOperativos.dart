...
class ForoSistemasOperativosScreen extends StatefulWidget {

  ForoSistemasOperativosScreen({Key key}) : super(key: key);

  @override
  _ForoSistemasOperativosScreenState createState() => _ForoSistemasOperativosScreenState();
}

class _ForoSistemasOperativosScreenState extends State<ForoSistemasOperativosScreen> {
                    ...
                    child: IconButton(
                        ...
                        onPressed: () {
                          if (mensaje.text.isNotEmpty) {
                            almacenarMensaje.collection("ForoSistemasOperativos").doc().set({
...
class MostrarMensajes extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance.collection("ForoSistemasOperativos").orderBy("tiempo").snapshots(),
